...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    $query = "SELECT DISTINCT(users.u_name) as c_name, users.u_id as c_id FROM users, courseDetails WHERE courseDetails.cd_c_id = $course_id AND users.u_id = courseDetails.cd_a_id";
//    $query = "SELECT * FROM courseDetails WHERE course_id = '$course_id'";
    //echo $query;
